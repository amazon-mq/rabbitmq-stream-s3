...
> Figure to re-verify. The coefficient of variation is recorded as 0.182 at both window 10 and window 50, which does not fit the collapse the sentence describes. One of the two is likely a transcription error. Re-check both against the raw runs before citing them.
